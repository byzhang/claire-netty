...
#ifndef _CLAIRE_NETTY_INSPECTOR_PPROFINSPECTOR_H_
#define _CLAIRE_NETTY_INSPECTOR_PPROFINSPECTOR_H_
...
private:
    ...
    static void OnContension(const HttpConnectionPtr& connection);
...
#endif // _CLAIRE_NETTY_INSPECTOR_PPROFINSPECTOR_H_
